    ...
    <div class="admin_main_block">
      ...
      <div class="admin_table_main">
        <el-table :data="dataList" v-loading="dataListLoading" @selection-change="selectionChangeHandle">
          ...
          <el-table-column :label="$t('inventory.outbound.category')">
            <template slot-scope="scope">
          ...
          <el-table-column prop="total" :label="$t('inventory.outbound.total')">
          </el-table-column>

          <el-table-column prop="operator" :label="$t('inventory.outbound.operator')">
          </el-table-column>

          <el-table-column prop="create_time" :label="$t('inventory.outbound.create_time')" width="150">
          </el-table-column>

          <el-table-column :label="$t('common.handle')" fixed="right" width="280">
            <template slot-scope="scope">
              <el-button v-if="isAuth('module:outbound:form')" type="success" icon="el-icon-download" @click="$router.push({name: 'module_outbound_form', query: {id: scope.row.id}})">
