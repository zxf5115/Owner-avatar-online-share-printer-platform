        ...
        <el-table :data="dataList" v-loading="dataListLoading" @selection-change="selectionChangeHandle">
          ...
          <el-table-column :label="$t('inventory.type')" width="80">
            <template slot-scope="scope">
              <span v-if="scope.row.outbound">
                {{ scope.row.outbound.type.text }}
              </span>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="code" :label="$t('inventory.code')" width="100">
          </el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      this.dataForm.outbound_id = this.$route.query.outbound_id;
      this.getDataList()
    }
  };
</script>
